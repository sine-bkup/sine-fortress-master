...
:	CClassMenu( pViewPort )
{
	...
	m_pClassButtons[TF_CLASS_SCIENTIST] = new CExImageButton( this, "scientist", "", this );
	m_pClassButtons[TF_CLASS_RUSHER] = new CExImageButton( this, "rusher", "", this );
#endif
	...
	m_pMvmUpgradeImages[TF_CLASS_SCIENTIST] = new vgui::ImagePanel( this, "MvMUpgradeImageScientist" );
	m_pMvmUpgradeImages[TF_CLASS_RUSHER] = new vgui::ImagePanel( this, "MvMUpgradeImageRusher" );
...
void CTFClassMenu::ApplySchemeSettings( IScheme *pScheme )
{
	...
	if ( ::input->IsSteamControllerActive() )
	{
		...
		m_pClassHintIcons[TF_CLASS_SCIENTIST] = dynamic_cast< CSCHintIcon* >( FindChildByName( "ScientistHintIcon" ) );
		m_pClassHintIcons[TF_CLASS_RUSHER] = dynamic_cast< CSCHintIcon* >( FindChildByName( "RusherHintIcon" ) );
...
int g_iLegacyClassSelectWeaponSlots[TF_LAST_NORMAL_CLASS] =
{
	...
	LOADOUT_POSITION_PRIMARY,		// TF_CLASS_SCIENTIST,
	LOADOUT_POSITION_PRIMARY,		// TF_CLASS_RUSHER,
};
...
static const char *g_sClassImagesBlue[] = {
	...
	"class_sel_sm_scientist_blu",
	"class_sel_sm_rusher_blu",
	"class_sel_sm_scout_blu",
};
...
static const char *g_sClassImagesRed[] = {
	...
	"class_sel_sm_scientist_red",
	"class_sel_sm_rusher_red",
	"class_sel_sm_scout_red",
};
